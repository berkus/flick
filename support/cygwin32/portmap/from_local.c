...
/* eeide@cs.utah.edu: Cygwin (beta 20.1) doesn't have SIOCGIFADDR.
   The original Sun portmapper code didn't make this `ioctl' anyway.
   It seems that the address info is already provided by SIOCGIFCONF. */
#ifdef SIOCGIFADDR
