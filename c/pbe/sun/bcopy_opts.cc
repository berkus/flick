 ...
 * I.E. in SUN, this returns #if BYTE_ORDER != BIG_ENDIAN, #else, and #endif,
 * indicating that byte swapping depends on the endianness of the host
 * compiling the code (satisfying XDR's requirements).
...
cast_stmt sun_mu_state::mu_bit_translation_necessary(int which,
						     mint_ref itype)
{
	cast_stmt macro = 0;
