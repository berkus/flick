 ...
 * I.E. in Trapeze, this obeys either IIOP or SUN semantics, depending on the
 * target transport of the generated stubs.
							 ...
							 mint_ref itype)
{
	...
	default:
		macro = 0;
		panic(("In `trapeze_mu_state::mu_bit_translation_necessary', "
