...
void khazana_mu_state::mu_mapping_reference(cast_expr expr,
					    cast_type /* ctype */,
					    mint_ref itype,
					    pres_c_mapping_reference *rmap)
{
	...
	/*
	 * In Khazana, object references are encoded as Interoperable Object
	 * References (IORs).  Section 10.6.2 of the CORBA 2.0 spec describes
	 * IORs in general; Section 12.7.2 describes the Khazana-specific
	 * parts.
	 *
